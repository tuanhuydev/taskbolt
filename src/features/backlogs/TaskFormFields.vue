...
watch(() => props.initialData, (data) => {
  if (data) {
    formData.value = {
      ...
      storyPoint: (data as any).storyPoint !== undefined && (data as any).storyPoint !== null
        ? Number((data as any).storyPoint)
        : undefined,
    }
  }
...
function handleSubmit() {
  ...
  const submitData: any = {
    ...
    storyPoint: formData.value.storyPoint !== undefined && formData.value.storyPoint !== null
