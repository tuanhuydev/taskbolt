...
const ProjectContextKey: InjectionKey<ProjectContext> = Symbol('ProjectContext');
...
export function useProjectContext() {
  ...
  if (!context) {
    throw new Error('useProjectContext must be used within a component that provides ProjectContext');
  }
