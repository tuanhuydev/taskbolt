...
import { Bold, Italic, Heading1, Heading2, List, ListOrdered, Code } from 'lucide-vue-next'
...
<template>
  <div :class="cn('border rounded-md overflow-hidden bg-background', props.class)">
    <!-- Toolbar -->
